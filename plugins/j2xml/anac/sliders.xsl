...
&lt;tr>
	...
	&lt;a class="accordion-toggle" data-toggle="collapse" href="#anac_<xsl:value-of select='generate-id(.)'/>"><xsl:value-of select="oggetto"/>&lt;/a>
	&lt;/td>
...
&lt;tr>
	&lt;td colspan="5">
		&lt;div id="anac_<xsl:value-of select='generate-id(.)'/>" class="accordion-body collapse">
